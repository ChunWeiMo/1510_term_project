...
main_story = {
    ...
    'intro': 'In the small town of Moland there is a ruined dungeon where a dragon sleeps.\n'
             ...
             'nearby field.\n"Guess I\'ll start with these small fry!"',
    'level 2': '"Hmm, now I feel a bit stronger I think it\'s time to visit the dragon\'s lair."\n'
               '"The townsfolk told me it was in a dungeon just past this field."\n'
               '"I hope there isn\'t anything too scary inside..."',
    'level 3': 'A loud resounding roar can be heard from deep in the depths of the dungeon\n. '
               '"Uh-oh...did the dragon wake up while I was leveling up?"\nYou hurry towards the sound.\n',
    'death': '"ARGHhhHHHHhhHhAAAAHhh..."\n'
