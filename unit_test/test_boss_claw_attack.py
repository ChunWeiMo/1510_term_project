...
from modules.battle.battle import boss_claw_attack


class TestClawAttack(TestCase):
    def test_character_def_less_than_boss_str(self):
        ...
        boss_claw_attack(character_dictionary, enemy_appeared)
        expected = {"Character_status": {"Level": 1, "HP": 93, "STR": 1, "DEF": 1,
                                         "CHR": 1, "SPD": 1, "LUK": 1}, "Debuff": {"Burn": 0}}
    ...
    def test_character_def_more_than_boss_str(self):
        ...
        enemy_appeared = {"Name": "Evil Dragon", "HP": 100, "STR": 7, "DEF": 4, "SPD": 3, "EXP": 10, "Gold": 10}
        boss_claw_attack(character_dictionary, enemy_appeared)
        expected = {"Character_status": {"Level": 1, "HP": 93, "STR": 1, "DEF": 10,
                                         "CHR": 1, "SPD": 1, "LUK": 1}, "Debuff": {"Burn": 0}}
        self.assertEqual(expected, character_dictionary)
    ...
    def test_character_hp_is_zero(self, mock_output):
        ...
        expected = ("\nAn enormous pair of claws swing at you. They are extremely sharp and slice through "
                    ...
                    "The Evil Dragon dealt 7 damage to you!\nYou have 0 HP left.\n\n")
