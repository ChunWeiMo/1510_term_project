...
from modules.battle.battle import enemy_defeated_talk


class TestDefeatedTalk(TestCase):
    def test_enemy_defeated_talk(self):
    ...
    def test_print_enemy_defeated_talk(self, mock_output, _):
        enemy_appeared = {"Name": "Slime", "HP": 10, "STR": 2, "DEF": 1, "SPD": 2, "EXP": 3, "Gold": 1}
        character_dictionary = {"Character_status": {"Level": 1, "HP": 100, "STR": 1,
                                                     "DEF": 5, "CHR": 1, "SPD": 1, "LUK": 1, "VIS": 3}, "EXP": 0,
                                "Items": {"Gold": 0, "Potions": 0}}
        enemy_defeated_talk(character_dictionary, enemy_appeared)
        expected = ("The talk was successful!\n\n"
                    "Slime is enamoured with you!\n"
                    "You've gained 1 gold!\n"
                    "You've gained 3 experience!\n"
                    "Your experience is now at 3/100!\n\n")
        self.assertEqual(expected, mock_output.getvalue())

    def test_enemy_defeated_talk_and_character_exp_greater_than_100(self):
